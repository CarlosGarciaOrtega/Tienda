                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title mb-20">Carrito</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a href="{{url('/')}}">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span>Carrito</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section class="cart__section section--padding">
                            ...
                            <div class="col-lg-8">
                                <div class="cart__table">
                                    <table class="cart__table--inner">
                                        ...
                                        <tbody class="cart__table--body" id="tabla-carrito">
                                    ...
                                    <div class="continue__shopping d-flex justify-content-between">
                                        ...
                                        <button class="continue__shopping--clear" type="submit" id="vaciar-carrito">Clear Cart</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="cart__summary border-radius-10">
                                    <div class="coupon__code mb-30">
                                        ...
                                        <div class="coupon__code--field d-flex">
                                            <label>
                                                <input id="cupon-carrito" class="coupon__code--field__input border-radius-5" placeholder="Coupon code" type="text">
                                            </label>
                                            <button id="aplicar-cupon" class="coupon__code--field__btn primary__btn" type="submit">Apply Coupon</button>
                                        </div>
                                    </div>
                                        ...
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                <tr class="cart__summary--total__list">
                                                    ...
                                                    <td class="cart__summary--amount text-right" id="sub-total-carrito-precio"></td>
                                                </tr>
                                                <tr class="cart__summary--total__list">
                                                    <td class="cart__summary--total__title text-left">TOTAL</td>
                                                    <td class="cart__summary--amount text-right" id="total-carrito-precio"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="cart__summary--footer">
                                        ...
                                        <ul class="d-flex justify-content-between">
                                            <li><a class="cart__summary--footer__btn primary__btn checkout" href="{{url('pago')}}">Pagar</a></li>
                                        </ul>
                                    </div>
                                </div> 
                            </div>
        ...
        <script type="text/javascript" src="{{url('assets/js/carrito.js')}}"></script>
</main>
@endsection