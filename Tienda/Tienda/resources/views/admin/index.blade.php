                                    ...
                                    <div class="product__view--mode d-flex align-items-center">
                                        ...
                                        <form>
                                            ...
                                            <div class="select shop__header--select">
                                                ...
                                                <select class="product__view--select" id="item-page" name="itemPage">
                                                    <option  {{ $itemPage==15 ? "selected" :" " }} value="15">15</option>
                                                    <option {{ $itemPage==21 ? "selected" :" " }}  value="21">21</option>
                                                    <option {{ $itemPage==27 ? "selected" :" " }}  value="27">27</option>
                                                    <option {{ $itemPage==33 ? "selected" :" " }}  value="33">33</option>
                                                    <option {{ $itemPage==45 ? "selected" :" " }}  value="45">45</option>
                                                </select>
                                            ...
                                            <div class="select shop__header--select">
                                                <select class="product__view--select" id="ordenacion" name="order">
                                                    <option  {{ $order=='precio-desc' ? "selected" :" " }} value="precio-desc">Precio descendente</option>
                                                    <option {{  $order=='precio-asc' ? "selected" :" " }}  value="precio-asc">Precio ascendente</option>
                                                    <option {{  $order=='fecha-desc' ? "selected" :" " }}  value="fecha-desc">Mas nuevo</option>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                                    <article class="product__card">
                                                        <div class="product__card--thumbnail">
                                                            <a class="product__card--thumbnail__link display-block" href="{{url('admin/'.$producto->id)}}">
                                                                <img class="product__card--thumbnail__img product__primary--img" src="{{url('productos/'.$producto->rutaimg)}}" alt="product-img">
                                                                <img class="product__card--thumbnail__img product__secondary--img" src="{{url('productos/'.$producto->rutaimg)}}" alt="product-img">
                                                                
                                                            </a>
                                                            
                                                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                                                <li class="product__card--action__list">
                                                                    <a class="product__card--action__btn" title="Editar" href="{{url('admin/'.$producto->id.'/edit')}}">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="product__card--action__btn--svg" width="17" height="17"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z"/></svg>
                                                                        <span class="visually-hidden">Editar</span>  
                                                                    </a>
                                                                </li>
                                                                <li class="product__card--action__list">
                                                                    <a class="product__card--action__btn" title="Ver" href="{{url('admin/'.$producto->id)}}">
                                                                ...
                                                                <li class="product__card--action__list">
                                                                    ...
                                                                    <form id="eliminar-producto" action="{{ url('admin/'.$producto->id ) }}" method="POST" class="d-none">
    @csrf
    @method('delete')
</form>

<button id="eliminar-producto-boton">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="product__card--action__btn--svg" width="17" height="17"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg>
    <span class="visually-hidden">Eliminar</span> 
                                                        ...
                                                        <div class="product__card--content">
                                                            ...
                                                            <h3 class="product__card--title"><a href="product-details.html">{{$producto->nombre}}</a></h3>
                                                            <h3 class="product__card--title"><a href="product-details.html"></a></h3>
                                                            <h3 class="product__card--title"><a href="product-details.html"><img src="" alt=""></a></h3>
...
{{$productos->appends([
    'itemPage' => $itemPage,
    'order' => $order,
])->onEachSide(2)->links('admin.pagination')}}
...
<script>
    document.getElementById('eliminar-producto-boton').addEventListener('click', function() {
